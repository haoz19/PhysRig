...
from exp_motion.train.cuboid_utils_ptero import (
    cuboid_finding,
...
class Trainer:
    def __init__(self, args):
        ...
        gtmesh_dir = os.path.join(dataset_dir, "mulmat_gt_50SP_1.2grid")
    ...
    def setup_simulation(self, dataset_dir, grid_size=80):
        ...
        # Haolan：创建gt_mask
        gt_mesh_initial = os.path.join(dataset_dir, "./mulmat_gt_50SP_1.2grid/gt_0.ply")
