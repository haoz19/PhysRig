...
def save_ply(points_list: List[np.ndarray], step: int, dataset_dir: str, frame_idx: int, for_gt: bool = False, subdir: str = None, prefix: str = None, suffix: str = None):
    """
    ...
    :param subdir: 子目录名称，如果提供，文件将保存到 dataset_dir/subdir 目录.
    :param prefix: 文件名前缀.
    :param suffix: 文件名后缀.
    """
    # 设置输出路径
