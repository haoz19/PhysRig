...
Generate the GT for suzanne rotation
...
class Trainer:
    ...
    def setup_simulation(self, dataset_dir, grid_size=80):
        ...
        print("x轴最小值：", bbox['min_x'])
        print("x轴最大值：", bbox['max_x'])
        print("y轴最小值：", bbox['min_y'])
        print("y轴最大值：", bbox['max_y'])
        print("z轴最小值：", bbox['min_z'])
        print("z轴最大值：", bbox['max_z'])
...
#             # pdb.set_trace()
        ...
        self.final_youngs_modulus = youngs_modulus
    ...
    def train(self):
        ...
        final_young = self.final_youngs_modulus.clone().detach()
