...
加入了youngs下限：100 + exp(θ)

进一步加入youngs上限：sigmoid化
...
class Trainer:
    def __init__(self, args):
        ...
        gtmesh_dir = os.path.join(dataset_dir, "mulmat_gt")
...
#         )
    ...
    def setup_simulation(self, dataset_dir, grid_size=80):
        ...
        # Haolan：创建gt_mask
        gt_mesh_initial = os.path.join(dataset_dir, "./mulmat_gt/gt_0.ply")
    ...
    def get_material_params(self, device):
        ...
        youngs_modulus = torch.clamp(youngs_modulus, 100.0, 6e4) # 不能对叶子节点使用
    ...
    def train_one_step(self):
        ...
        for start_time_idx in range(0, window_size, temporal_stride):
            ...
            #     if start_time_idx == 0 && self.step == self.train_iters - 1:
