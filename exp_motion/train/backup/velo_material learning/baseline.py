...
1.优化速度和材质联合学习，先分开预训练，再联合微调

2.测试不同部分不同youngs的情况 (l2和CD loss)
...
class Trainer:
    def __init__(self, args):
        ...
        gtmesh_dir = os.path.join(dataset_dir, "./train_velo/6e3gt")
    ...
    def setup_simulation(self, dataset_dir, grid_size=80):
        ...
        # Haolan：创建gt_mask
        gt_mesh_initial = os.path.join(dataset_dir, "./train_velo/6e3gt/gt_0.ply")
...
#         pdb.set_trace()
    ...
    def train_one_step(self):
        ...
        for start_time_idx in range(0, window_size, temporal_stride):
            ...
            # if self.step % 20 == 0 or self.step == self.train_iters - 1:
