...
class GaussianModel:
    ...
    def __init__(self, sh_degree: int): # def __init__(self, sh_degree: int = 3)
        self.active_sh_degree = 0
        self.max_sh_degree = 0 # 原本是3，但luciddreamer生成的0: max_sh_degree = sh_degree
    ...
    def load_ply(self, path):
        ...
        print(f"extra_f_names length: {len(extra_f_names)}")
