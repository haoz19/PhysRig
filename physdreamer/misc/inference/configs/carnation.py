...
# dataset_dir = "/mnt/e/Project/PhysDreamer/data/physics_dreamer/carnation/"
dataset_dir = "/scratch/bbqk/haozhang/files/physdreamer/PhysDreamer/data/carnations"
result_dir = "output/carnations/demos"
# exp_name = "/mnt/e/Project/PhysDreamer/carnations"
exp_name = "self_carnations"


model_list = [
    
 # "/scratch/bbqk/haozhang/files/physdreamer/PhysDreamer/models/physdreamer/carnations/model",
    # "/scratch/bbqk/haozhang/files/physdreamer/PhysDreamer/output/inverse_sim/Test_151_decay_1.0_substep_768_se3_field_lr_0.001_tv_0.0001_iters_300_sw_6_cw_1/seed0/checkpoint_model_000300",
  "/scratch/bbqk/haozhang/files/physdreamer/PhysDreamer/output/inverse_sim/Test_14_decay_1.0_substep_768_se3_field_lr_0.001_tv_0.0001_iters_200_sw_6_cw_1/seed0/checkpoint_model_000200",
