# path to python
python=/scratch/bbqk/haozhang/.conda/envs/physdreamer/bin/python

$python demo.py --scene_name carnation --apply_force --force_id 1 --point_id 0 --force_mag 3.0 --cam_id 0
