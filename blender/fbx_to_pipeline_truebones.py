...
Usage:
  blender --background --python motionrep/datatools/fbx_to_pipeline_truebones.py -- \\
...
def parse_args():
    ...
    if "--" not in argv:
        ...
        print("Usage: blender --background --python fbx_to_pipeline_truebones.py -- <fbx_path> <output_dir> [options]")
        sys.exit(1)
...
def main():
    ...
    if args.skeleton_mode != "none" and armature_obj is None:
